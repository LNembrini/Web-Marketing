...
#`raw_6_camp_event.csv`  contiene gli eventi (sents, open e clicks) relativi alle comunicazioni email di marketing:
...
df6_overview #da gennaio 2019 a aprile a 190427 clienti
...
plot_df6_dist_opened #la maggior parte delle mail non viene aperta
...
plot_df6_dist_clickedbytyp #la maggior parte dei clienti non clicca sulla mail
